...
from utils.config import (
    MINIO_CLEANED_SECUNDARIOS, PLACE_OSM, TAGS_COMERCIO, TAGS_NEGATIVOS, TAGS_ALIMENTACION,
...
if __name__ == "__main__":
    procesar_y_subir_osm(TAGS_COMERCIO, OBJ_COMERCIO, MINIO_CLEANED_SECUNDARIOS)
    procesar_y_subir_osm(TAGS_NEGATIVOS, OBJ_NEGATIVOS, MINIO_CLEANED_SECUNDARIOS)
    procesar_y_subir_osm(TAGS_ALIMENTACION, OBJ_ALIMENTACION, MINIO_CLEANED_SECUNDARIOS)
