...
def buscar_archivos_en_carpeta(carpeta):
    ...
    archivos = [archivo for archivo in os.listdir(carpeta) if archivo.endswith('.py') and archivo != 'main.py' and "funciones" not in archivo]
...
def menu_seleccion(lista_archivos):
    ...
    while True:
        print("\n" + "="*40)
        print("  MENÚ PIPELINE EXTRACCION")
        print("="*40)
        ...
        print("-" * 40)
        print(f"  0. Salir de la extracción")
        print("="*40)
