...
# Nota: Se usa GaussianNB en lugar de MultinomialNB porque los embeddings de
# sentence-transformers son valores continuos que pueden ser negativos.
# MultinomialNB exige features ≥ 0, GaussianNB maneja cualquier distribución gaussiana.
